...
class Thermal_master_item_details extends CI_Model
{
    protected $_table = "thermal_master_item_details";
    ...
    // update  
    public function update($data_update, $internal_item) {
        $this->db->where('internal_item', $internal_item);
    ...
    // delete data
    function delete($internal_item) {
        $this->db->where('internal_item', $internal_item);
        $this->db->delete($this->_table);
    }

    //check exist
    public function isAlreadyExist($internal_item) {
        $this->db->where('internal_item', $internal_item);
