...
class Woven_master_item_supply_save extends CI_Model
{
    protected $_table = "woven_master_item_supply_save";
    ...
    // delete data
    function deleteItem($po_no, $internal_item, $length_btp, $code_name ) {
        $array = array('po_no' => $po_no, 'internal_item' => $internal_item, 'length_btp' => $length_btp, 'code_name' => $code_name);
        $this->db->where($array);
