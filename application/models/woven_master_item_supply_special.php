...
// Dùng cho Cập nhật chiều dài chỉ của code vật tư đặc biệt
class Woven_master_item_supply_special extends CI_Model
{
    protected $_table = "woven_master_item_supply_special";
