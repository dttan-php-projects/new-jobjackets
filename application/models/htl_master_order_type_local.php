...
class Htl_master_order_type_local extends CI_Model
{
    protected $_table = "htl_master_order_type_local";
    ...
    // read all data
    public function read($col=null, $orderBy=null ) 
    {
        if ($col == null ) $col = 'order_type_local';
